        ...
        <Link
            ...
            className={tw(
                'font-medium transition duration-150 ease-in-out focus:outline-none',
                {
                    ...
                    'border-primary-400 focus:border-primary-700 dark:border-primary-600 text-gray-900 dark:text-gray-100':
                        active,
                    'bg-primary-50 text-primary-700 focus:bg-primary-100 focus:text-primary-800 dark:bg-primary-900/50 dark:focus:border-primary-300 dark:focus:bg-primary-900 dark:focus:text-primary-200 dark:text-primary-50':
                        active && responsive,
