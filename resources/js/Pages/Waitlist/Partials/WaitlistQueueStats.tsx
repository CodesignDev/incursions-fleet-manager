        ...
        <>
            ...
            <div className="flex flex-row gap-x-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <div className="flex flex-col items-start gap-y-1.5">
                    <p>
                        Your queue position is only indicative of where you are on the waitlist, it does not indicate
                        how long it will be before you are invited to the fleet.
                    </p>
                    <p className={tw({ hidden: !showMoreInfo })}>
                        If you are unable to fly a ship that can fill the next slot that opens in the fleet, you may not
                        be the next person to be invited, likewise if you are the only person on the waitlist in that
                        ship and a a slot opens you will be the next person invited.
                    </p>
                    <button
                        type="button"
            ...
            <div className="grid-rows-auto grid grid-cols-[min-content_1fr] gap-x-4 divide-y divide-gray-600">
