...
import { DoctrineProvider } from '@/Providers/DoctrineProvider'
import { WaitlistCharactersProvider } from '@/Providers/WaitlistCharactersProvider'
import { Character, Doctrine, PageProps, WaitlistCategory } from '@/types'
...
export default function ViewWaitlist({ categories, characters, doctrines }: PageProps<ViewWaitlistPageProps>) {
    ...
    return (
        <ApplicationLayout header={<PageHeader>Join Waitlist</PageHeader>}>
            ...
            <div className="py-8">
                <DoctrineProvider doctrines={doctrines}>
