                    ...
                    <div className="bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                        <div className="space-y-4 p-6 text-gray-800 dark:text-gray-200">
                            <div className="flex flex-row justify-between">
                                ...
                                {fleets.length > 0 && (
                                    <Link
                                        href={route('fleets.register-fleet')}
                                        styledAsButton
                                        className="-mt-2 items-center border-transparent bg-primary-600 text-white hover:bg-primary-500 focus:ring-primary-500 active:bg-primary-700 dark:border-transparent dark:bg-primary-700 dark:hover:bg-primary-600 dark:focus:bg-primary-600 dark:focus:ring-primary-600 dark:active:bg-primary-800"
                                    >
                                        <PlusIcon className="mr-1 size-4 stroke-white" />
                                        Register Fleet
                                    </Link>
                                )}
                            </div>
                            ...
                            {fleets.length > 0 ? (
                                <div className="flex flex-col divide-y rounded border dark:divide-gray-600 dark:border-gray-600 dark:bg-gray-900">
                                    {fleets.map((fleet) => (
